"""add conversation id to refund requests

Revision ID: 63b19dd28b02
Revises: bec7617bce63
Create Date: 2026-08-14 08:32:38.147334
...
revision: str = '63b19dd28b02'
down_revision: Union[str, Sequence[str], None] = 'bec7617bce63'
...
def upgrade() -> None:
    ...
    op.add_column('refund_requests', sa.Column('conversation_id', sa.String(length=50), nullable=True))
    op.create_foreign_key(None, 'refund_requests', 'conversations', ['conversation_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_column('refund_requests', 'conversation_id')
